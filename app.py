...
def report(post_id):
	...
	data = {
		...
		"embeds": [
			{
				"title": "REPORT",
				"description": "Post " + str(post_id) + " has been reported.\nReported for: " + report_content,
				"url": "https://right-burro-unique.ngrok-free.app" + url_for("post_page",post_id=post_id),
				"color": 16734296
			}
		],
		"attachments": []
	...
	print(data)
	r = requests.post(os.getenv("REPORT_WEBHOOK"), json = data)
	#print()
